...
<div class="jumbotron jumbotron1" style="text-align: center;">
  ...
  <p><?php echo "Bem vindo/a <b>".$uname."</b>!" ?></p>
    ...
    <?php
     ...
     ?>
     <form action="insereAvatar2.php" method="post" enctype="multipart/form-data">
        <br><br>
    ...
    <form action="updpassword2.php" method="post">
    <label for="exampleInputFile">Mudar Password</label>
      <input type="Password" class="form-control" name="newpw" id="newpw" required="" style="width: 100%" placeholder="Password" value="<?php echo $pw;?>">
